return {
    ...
    config = function()
        ...
        local on_attach = function(client, bufnr)
            ...
            keymap.set("n", "<leader>ws", function() vim.lsp.buf.workspace_symbol() end, opts, { desc = "Find Worksplace Symbol" })
            ...
            keymap.set('n', '<leader>lr', function() require('telescope.builtin').lsp_references() end, { noremap = true, silent = true, desc = "Find References in Telescope" })
